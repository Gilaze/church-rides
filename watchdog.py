...
ALERT_COOLDOWN = 3600  # Don't send another alert within 1 hour
...
def should_send_alert():
    """
    Determine if we should send an alert based on cooldown period.
    """
    ...
    return time_since_last_alert >= ALERT_COOLDOWN
...
def run_watchdog():
    ...
    Main watchdog loop.
    """
    global consecutive_failures, last_alert_time
